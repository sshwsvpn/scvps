...
export OK="${Green}--->${FONT}"
export ERROR="${RED}[ERROR]${FONT}"
export GRAY="\e[1;30m"
export NC='\e[0m'
...
export NAMES=$(whoami)
export IMP="wget -q -O"
export LOCAL_DATE="/usr/bin/"
export MYIP=$(wget -qO- ipinfo.io/ip)
export CITY=$(curl -s ipinfo.io/city)
export TIME=$(date +'%Y-%m-%d %H:%M:%S')
export RAMMS=$(free -m | awk 'NR==2 {print $2}')
export GITHUB_CMD="https://raw.githubusercontent.com/arismaramar/gif/"
